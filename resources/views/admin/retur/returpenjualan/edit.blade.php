...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Retur Penjualan</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Form Edit Retur Penjualan</h3>
            </div>
            <form action="{{ route('returpenjualan.update', $retur->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card-body">
                    @if(session('error'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               class="form-control" 
                               value="{{ $retur->transaksi->nomor_transaksi ?? '-' }}" 
                               readonly>
                        <small class="form-text text-muted">Transaksi tidak dapat diubah</small>
                    </div>
